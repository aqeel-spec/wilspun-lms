  ...
  return (
    <div className="text-black dark:text-white">
      ...
      <h1 className={`${styles.title} 800px:!text-[45px]`}>
        What is <span className="text-gradient">Wilspun LMS?</span>
      </h1>
      ...
      <div className="w-[95%] 800px:w-[85%] m-auto">
        <p className="text-[18px] font-Poppins">
          ...
          no further than Wilspun LMS, the premier programming community dedicated
          to helping new programmers achieve their goals and reach their full
          potential.
          <br />
          <br />
          As the founder and CEO of Wilspun LMS, I know firsthand the challenges
          that come with learning and growing in the programming industry.
          That&apos;s why I created Wilspun LMS &ndash; to provide new programmers
          ...
          <br />
          <br />
          At Wilspun LMS, we believe that price should never be a barrier to
          ...
          <br />
          <br />
          But Wilspun LMS is more than just a community &ndash; we&apos;re a
          ...
          <br />
          <br />
          With Wilspun LMS by your side, there&apos;s nothing standing between you
          ...
          <br />
          <br />
          So what are you waiting for? Join the Wilspun LMS family today and let&apos;s
        ...
        <h5 className="text-[18px] font-Poppins">
          Founder and CEO of Wilspun LMS
        </h5>
        <br />
        <br />
        <br />
