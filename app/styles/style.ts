export const styles = {
    ...
    button:"flex flex-row justify-center items-center py-3 px-6 rounded-full cursor-pointer bg-gray-200 min-h-[45px] w-full text-[16px] font-Poppins font-semibold"
}