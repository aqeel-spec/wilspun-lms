  ...
  return (
    <div className="mt-[100px]">
      <div className="container mx-auto px-4 sm:px-8">
        <div className="py-8">
          <h2 className="text-2xl pb-6 font-semibold leading-tight dark:text-white text-black">
            All Users
          </h2>
          <div className="flex mr-auto justify-end items-center">
            {isTeam && (
              <button
          ...
          <div className="my-2 flex sm:flex-row flex-col">
            <div className="flex flex-row mb-1 sm:mb-0">
              <div className="relative">
                <select
                  ...
                  className=" h-full rounded-l border block appearance-none w-full bg-white dark:bg-gray-800 border-gray-400 dark:border-gray-700 text-gray-700 dark:text-gray-200 py-2 px-4 pr-8 leading-tight focus:outline-none focus:bg-white dark:focus:bg-gray-700 focus:border-gray-500"
                >
                  <option>5</option>
                  <option>10</option>
                  <option>20</option>
            ...
            <div className="block relative">
              <span className="h-full absolute inset-y-0 left-0 flex items-center pl-2">
                <svg
                  viewBox="0 0 24 24"
                  className="h-4 w-4 fill-current text-gray-500 dark:text-gray-200"
                >
            ...
            <div className="inline-block min-w-full shadow rounded-lg overflow-hidden">
                        ...
                        <td className="px-5 py-5 border-b border-gray-200 dark:border-gray-700 bg-white dark:bg-gray-800 text-sm">
                          <span
                            className={`relative inline-block px-3 py-1 font-semibold leading-tight ${
                              row.isVerified ? "text-green-900" : "text-red-900"
                            }`}
                          >
                            <span
                              aria-hidden
                              className={`absolute inset-0 ${
                                row.isVerified ? "bg-green-200" : "bg-red-200"
              ...
              <div className="px-5 py-5 bg-white dark:bg-gray-800 border-t dark:border-gray-700 flex flex-col xs:flex-row items-center xs:justify-between">
                <span className="text-xs xs:text-sm text-gray-900 dark:text-gray-200">
                  Showing {currentPage} to {totalPages} of {filteredRows.length}{" "}
                  Entries
                </span>
